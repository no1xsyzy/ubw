...
class BaseHandler(HandlerInterface):
    ...
    def __room_change_callback(self, client: client_.BLiveClient, command: dict):
        return self._on_room_change(client, models.RoomChangeMessage.from_command(command['data']))
